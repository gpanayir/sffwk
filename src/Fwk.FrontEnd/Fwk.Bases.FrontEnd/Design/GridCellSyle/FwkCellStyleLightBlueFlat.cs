...
{
    [ToolboxItem(false)]
    public partial class FwkCellStyleLightBlueFlat: Component,IFwkCellStyle
    {

        public FwkCellStyleLightBlueFlat()
        {
            InitializeComponent();
        }

        public FwkCellStyleLightBlueFlat(IContainer container)
        {
            container.Add(this);
