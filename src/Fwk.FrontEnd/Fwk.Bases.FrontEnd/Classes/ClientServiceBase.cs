...
namespace Fwk.Bases.FrontEnd
{
    ...
    {
        static IServiceConnector _IConnector;
            ...
            where TResponse : IServiceContract, new()
        {
            ...
            if (wResponse.Error == null)
            {
                ...
                if (req.CacheSettings != null && req.CacheSettings.CacheOnClientSide) //--------------------------------------->>> Implement the cache factory
                {
                    ...
                    res = ClientCacheMannager.Get(req);
                ...
                {
                    wResponse = _IConnector.ExecuteService<TRequest, TResponse>(pRequest);
                    ...
                    if (req.CacheSettings != null && req.CacheSettings.CacheOnClientSide)
                    {
                        ...
                        //su almacen en cache
                        if (wResponse.Error == null)
                            ClientCacheMannager.Add(req, wResponse);
                    }
                }
            }
        ...
        /// <author>moviedo</author>
        internal ServiceConfigurationCollection GetAllServices()
        {
            InitWrapper();

            return _IConnector.GetAllServices();
        ...
        /// <author>moviedo</author>
        internal ServiceConfiguration GetServiceConfiguration(string pServiceName)
        {
            InitWrapper();
            return _IConnector.GetServiceConfiguration(pServiceName);
        }
        /// <summary>
        ...
        {
            InitWrapper();
            _IConnector.SetServiceConfiguration(pServiceName,pServiceConfiguration); 
        }
        ...
        {
            InitWrapper();
            _IConnector.AddServiceConfiguration(pServiceConfiguration); 
        }
        ...
        public void DeleteServiceConfiguration(string pServiceName)
        {
            ...
            _IConnector.DeleteServiceConfiguration(pServiceName); 
        }
