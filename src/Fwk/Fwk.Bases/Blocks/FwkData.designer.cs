...
namespace Fwk.ConfigData
{
    ...
    partial void OnParamTypeIdChanging(int value);
    partial void OnParamTypeIdChanged();
    partial void OnParamRefIdChanging(int value);
    partial void OnParamRefIdChanged();
    partial void OnDescriptionChanging(string value);
    partial void OnDescriptionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ParamRefId", DbType="Int NOT NULL")]
		public int ParamRefId
		{
			get
			{
				return this._ParamRefId;
			}
			set
			{
				if ((this._ParamRefId != value))
				{
					if (this._Param1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnParamRefIdChanging(value);
					this.SendPropertyChanging();
					this._ParamRefId = value;
					this.SendPropertyChanged("ParamRefId");
					this.OnParamRefIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Param_Param", Storage="_Params", ThisKey="ParamId", OtherKey="ParamRefId")]
		public EntitySet<Param> Params
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Param_Param", Storage="_Param1", ThisKey="ParamRefId", OtherKey="ParamId", IsForeignKey=true)]
		public Param Param1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Param1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._ParamRefId = value.ParamId;
					}
					else
					{
						this._ParamRefId = default(int);
					}
