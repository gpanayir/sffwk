...
namespace Fwk.Logging
{
    ...
    /// <date>200609/02</date>
    /// <author>moviedo</author>
    [XmlInclude(typeof(CopyOfEvent)), Serializable]
    public class CopyOfEvent : Fwk.Bases.Entity
    {
        #region <private members>
        ...
        /// <param name="pSource">Origen del evento.</param>
        /// <param name="pMessage">Mensaje descriptivo del evento.</param>
        public CopyOfEvent(EventType pType, string pSource, string pMessage)
        {
            _Id = Guid.NewGuid();
            _LogType = pType;
            _Source = pSource;
        ...
        /// <param name="pMachine">Equipo donde se origina el evento.</param>
        /// <param name="pUserName">Usuario que origina el evento.</param>
        public CopyOfEvent(EventType pType, string pSource, string pMessage, string pMachine, string pUserName)
        {
            _Id = Guid.NewGuid();
            _LogType = pType;
            _Source = pSource;
        ...
        /// <param name="pUserName">Usuario que origina el evento.</param>
        /// <param name="appId">Identificador de la aplicación que genera el log</param>
        public CopyOfEvent(EventType pType, string pSource, string pMessage, string pMachine, string pUserName, string appId)
        {
            _Id = Guid.NewGuid();
            _AppId = appId;
            _LogType = pType;
