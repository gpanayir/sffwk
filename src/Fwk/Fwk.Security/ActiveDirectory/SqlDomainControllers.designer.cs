...
namespace Fwk.Security.ActiveDirectory
{
	...
	[Table(Name="dbo.DomainControllers")]
    ...
    partial void OnDCIpChanged();
		...
		[Column(Storage="_DCId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int DCId
		{
			get
			{
		...
		[Column(Storage="_DCHostName", DbType="VarChar(80) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_DCIp", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string DCIp
		{
			get
			{
