...
namespace CodeGenerator.Back.Common
{
    public class CommonConstants
    {
        ...
        public const string CONST_ENTITY_PREFIX_TYPE = "[PrefixType]";
        public const string CONST_ENTITY_PREFIXSUFIX = "[PrefixSufix]";
        public const string CONST_ENTITY_PREFIXSUFIX_COLLECTION = "[PrefixSufixCollection]";
        
        public const string CONST_ENTITY_EntitiesClass = "[EntitiesClass]";
        ...
        public const string CONST_NAMESPACE_SVC = "[NamespaceSVC]";
        public const string CONST_NAMESPACE_ISVC = "[NamespaceISVC]";
        public const string CONST_NAMESPACE_DAC = "[NamespaceDAC]";
        public const string CONST_NAMESPACE_TDG = "[NamespaceTDG]";
        public const string CONST_NAMESPACE_BC = "[NamespaceBC]";
        public const string CONST_NAMESPACE_BE_DE = "[NamespaceDEBE]";
