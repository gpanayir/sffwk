...
namespace CodeGenerator.Controls
{
    ...
    public partial class ListViewCodeGenerated : UserControl
    {
        ...
        public Color ForeColorTDG
        {
            get { return trvCodeGenerated.Nodes["TDG"].ForeColor; }
            set { trvCodeGenerated.Nodes["TDG"].ForeColor = value; }
        }
        ...
        public TreeNode GeneratedBECodeList
        {
            get { return _NodeBE; }
            set{_NodeBE = value;}
        }
        ...
        public void LoadTtreeView()
        {
            ...
            if (_NodeTDG != null)
                LoadGeneratedCode(ComponentLayer.TDG, _NodeTDG);
        ...
        #endregion
        public String GetFirstEntityCode(String pParentKey)
        {
            

            if(trvCodeGenerated.Nodes[pParentKey].Nodes.Count!=0)
            {
                return ((GeneratedCode)trvCodeGenerated.Nodes[pParentKey].Nodes[0].Tag).Code.ToString();
            }
        ...
        public String GetLastSelectedEntityCode(String pParentKey, String pEntityName)
        {
            ...
            {
                if (wNode.Text == pEntityName)
                    return ((GeneratedCode)wNode.Tag).Code.ToString();
            }
        ...
        private void SaveGeneratedCodeFiles(string pzsPath)
        {
            ...
            SaveGeneratedCodeFiles(pzsPath, ComponentLayer.TDG);
