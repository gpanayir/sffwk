    ...
    public class SPCodeGenerator : SPCodeGeneratorBase
    {
        ...
        protected override void GenCodeGetAll(MethodInfo pMethodInfo,string pActionCode, List<GeneratedCode> pProceduresCode)
        {
            ...
            try
            {
                ...
                wBuilder.Replace(CommonConstants.CONST_DESCRIPTION, GetStoredProcedureDescription(pMethodInfo.Entity.Table.Name,pMethodInfo.Action));
                wBuilder.Replace(CommonConstants.CONST_STOREDPROCEDURE_NAME, GetStoredProcedureName(pMethodInfo.Entity.Table.Name, pMethodInfo.Entity.Table.Schema, pMethodInfo.Action));

                wCode = new GeneratedCode();
                wCode.Id = pMethodInfo.Entity.Name;
                wCode.Code.Append(wBuilder.ToString());
                wCode.MethodActionType = pMethodInfo.Action;
        ...
        //        wBuilder.Replace(CommonConstants.CONST_DESCRIPTION, GetStoredProcedureDescription(pMethodInfo.Entity.Table.Name, pMethodInfo.Action));
        //        wBuilder.Replace(CommonConstants.CONST_StoredProcedure_NAME, GetStoredProcedureName(pMethodInfo.Entity.Table.Name, pMethodInfo.Action));
        ...
        protected override string GenCodeParameters(MethodInfo pMethodInfo)
        {
            ...
            if (pMethodInfo.Action == MethodActionType.Get)
            {
                foreach (fwkDataEntities.Column wColumn in pMethodInfo.Entity.Table.Columns)
                {
                    if (wColumn.KeyField && wColumn.Selected)
                    {
                        StringBuilder wParamBuilder = this.BuildParameter(wColumn, pMethodInfo.Action, false, false);
        ...
        protected override string GenCodeInsertParameters(MethodInfo pMethodInfo)
        {
            ...
            foreach (fwkDataEntities.Column wTableFieldInfo in pMethodInfo.Entity.Table.Columns)
            {
                ...
                {
                    StringBuilder wParamBuilder = base.BuildParameter(wTableFieldInfo, pMethodInfo.Action, true, true);
                    wBuilder.Append(wParamBuilder.ToString());
                }
            }
            RemoveChars(wBuilder, 3);
        ...
        protected override  string GenCodeDeleteParameters(MethodInfo pMethodInfo)
        {
            ...
            foreach (fwkDataEntities.Column wColumn in pMethodInfo.Entity.Table.Columns)
            {
                if (wColumn.KeyField && wColumn.Selected)
                {
                    StringBuilder wParamBuilder = BuildParameter(wColumn, pMethodInfo.Action, false, false);
                    wBuilder.Append(wParamBuilder.ToString());
                }
            }
        ...
        protected override string GenCodeUpdateParameters(MethodInfo pMethodInfo)
        {
            ...
            foreach (fwkDataEntities.Column wColumn in pMethodInfo.Entity.Table.Columns)
            {
                ...
                {
                    StringBuilder wParamBuilder = BuildParameter(wColumn, pMethodInfo.Action, false, true);
                    wBuilder.Append(wParamBuilder.ToString());
                }
            }
