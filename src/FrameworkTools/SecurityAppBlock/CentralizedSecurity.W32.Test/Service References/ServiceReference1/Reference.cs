...
namespace CentralizedSecurity.W32.Test.ServiceReference1 {
    ...
    public interface ICoreSecurity {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ICoreSecurity/Authenticate", ReplyAction="http://tempuri.org/ICoreSecurity/AuthenticateResponse")]
        System.IAsyncResult BeginAuthenticate(string userName, string password, string domain, System.AsyncCallback callback, object asyncState);
        
        CentralizedSecurity.W32.Test.ServiceReference1.LoogonUserResult EndAuthenticate(System.IAsyncResult result);
    ...
    public partial class CoreSecurityClient : System.ServiceModel.ClientBase<CentralizedSecurity.W32.Test.ServiceReference1.ICoreSecurity>, CentralizedSecurity.W32.Test.ServiceReference1.ICoreSecurity {
        ...
        public System.IAsyncResult BeginAuthenticate(string userName, string password, string domain, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginAuthenticate(userName, password, domain, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public CentralizedSecurity.W32.Test.ServiceReference1.LoogonUserResult EndAuthenticate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAuthenticate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return this.BeginAuthenticate(userName, password, domain, callback, asyncState);
        }
        
        private object[] OnEndAuthenticate(System.IAsyncResult result) {
            CentralizedSecurity.W32.Test.ServiceReference1.LoogonUserResult retVal = this.EndAuthenticate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void AuthenticateAsync(string userName, string password, string domain) {
            this.AuthenticateAsync(userName, password, domain, null);
        }
        
        public void AuthenticateAsync(string userName, string password, string domain, object userState) {
            ...
            base.InvokeAsync(this.onBeginAuthenticateDelegate, new object[] {
                        userName,
                        password,
                        domain}, this.onEndAuthenticateDelegate, this.onAuthenticateCompletedDelegate, userState);
        }
