...
namespace Fwk.Security.ActiveDirectory.Test
{
    public partial class UserPropertiesUpdate : Form
    {
        ...
        {
            ///172.22.12.110
            ADHelper _ADHelper = new ADHelper("LDAP://ARCORRSF71DC03.Pelsoft.ar/DC=Pelsoft,DC=ar", "moviedo", "Lincelin9");

            _ADHelper.User_Get_ByName("moviedo");

            _ADHelper.User_ChangeEmail("moviedo","marcelo.oviedo@Pelsoft.com.ar");
