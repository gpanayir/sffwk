...
{
    [ToolboxItem(true)]
    public partial class CommonEnumComboBox : ComboBoxDxBase, ISupportInitialize
    {
        #region [Constructor]

        public CommonEnumComboBox()
        {
            InitializeComponent();
        }

        public CommonEnumComboBox(IContainer container)
        {
            container.Add(this);
        ...
        private TypesEnum _enumType = TypesEnum.AuthenticationModeEnum;
        //private ParamCampaingsList _showedParamCampaingsList = null;
