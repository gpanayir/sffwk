...
namespace Fwk.Controls.Win32
{
	...
	public class FloatWindow : Form, IDockListContainer
	{
        ...
        internal const int WM_CHECKDISPOSE = (int)(Fwk.Controls.Win32.DocpanelEnums.Msgs.WM_USER + 1);
		...
		internal void TestDrop(DragHandler dragHandler)
		{
			...
			if (User32.SendMessage(Handle, (int)Msgs.WM_NCHITTEST, 0, lParam) == (uint)HitTest.HTCAPTION)
